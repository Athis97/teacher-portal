            ...
            <div class="my-8 rounded bg-white shadow-md">
                <table class="min-w-full bg-white">
                    <thead class="text-gray-500">
                        <tr class="">
                            <th class="my-2 px-4 py-3 text-start"><div class="border-e-2">Name</div></th>
                            <th class="my-2 px-4 py-3 text-start"><div class="border-e-2">Subject</div></th>
                            <th class="my-2 px-4 py-3 text-center"><div class="border-e-2">Marks</div></th>
                            <th class="my-2 px-4 py-3 text-center"><div class="">Actions</div></th>
                        </tr>
                    </thead>
